...
public final class APU: MemoryAddressable {
    private struct Registers {
        static let channel1Range: ClosedRange<Address> = 0xff10...0xff14
        static let channel2Range: ClosedRange<Address> = 0xff15...0xff19
        static let channel3Range: ClosedRange<Address> = 0xff1a...0xff1e
        static let channel4Range: ClosedRange<Address> = 0xff1f...0xff23
        static let controlRange: ClosedRange<Address> = 0xff24...0xff26
        static let wavePatternRange: ClosedRange<Address> = 0xff30...0xff3f
    }
