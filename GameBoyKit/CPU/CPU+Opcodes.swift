extension CPU {
    ...
    public static let range0nOpcodes: [Opcode] = [
        ...
        Opcode(mnemonic: "INC BC") { cpu, _ in cpu.increment(pair: &cpu.bc) },
        ...
        Opcode(mnemonic: "ADD HL, BC") { cpu, _ in cpu.add(value: cpu.bc, to: &cpu.hl) },
        Opcode(mnemonic: "LD A, (BC)") { cpu, ctx in cpu.load(address: cpu.bc, into: &cpu.a, context: ctx) },
        Opcode(mnemonic: "DEC BC") { cpu, _ in cpu.decrement(pair: &cpu.bc) },
    ...
    public static let range1nOpcodes: [Opcode] = [
        ...
        Opcode(mnemonic: "INC DE") { cpu, _ in cpu.increment(pair: &cpu.de) },
        ...
        Opcode(mnemonic: "ADD HL, DE") { cpu, _ in cpu.add(value: cpu.de, to: &cpu.hl) },
        Opcode(mnemonic: "LD A, (DE)") { cpu, ctx in cpu.load(address: cpu.de, into: &cpu.a, context: ctx) },
        Opcode(mnemonic: "DEC DE") { cpu, _ in cpu.decrement(pair: &cpu.de) },
    ...
    public static let range2nOpcodes: [Opcode] = [
        ...
        Opcode(mnemonic: "INC HL") { cpu, _ in cpu.increment(pair: &cpu.hl) },
        ...
        Opcode(mnemonic: "ADD HL, HL") { cpu, _ in cpu.add(value: cpu.hl, to: &cpu.hl) },
        Opcode(mnemonic: "LD A, (HL+)") { cpu, ctx in cpu.loadFromAddressAndIncrementHL(to: &cpu.a, context: ctx) },
        Opcode(mnemonic: "DEC HL") { cpu, _ in cpu.decrement(pair: &cpu.hl) },
    ...
    public static let range3nOpcodes: [Opcode] = [
        ...
        Opcode(mnemonic: "INC SP") { cpu, _ in cpu.increment(pair: &cpu.sp) },
        ...
        Opcode(mnemonic: "ADD HL, SP") { cpu, _ in cpu.add(value: cpu.sp, to: &cpu.hl) },
        Opcode(mnemonic: "LD A, (HL-)") { cpu, ctx in cpu.loadFromAddressAndDecrementHL(to: &cpu.a, context: ctx) },
        Opcode(mnemonic: "DEC SP") { cpu, _ in cpu.decrement(pair: &cpu.sp) },
    ...
    public static let rangeFnOpcodes: [Opcode] = [
        ...
        Opcode(mnemonic: "LD SP, HL") { cpu, _ in cpu.load(value: cpu.hl, into: &cpu.sp) },
